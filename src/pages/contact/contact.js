...
document.getElementById("Name").addEventListener("blur", ()=> validateName(nameError)); 
document.getElementById("email").addEventListener("blur",()=> validateEmail(emailError));
document.getElementById("phone").addEventListener("blur",()=> validatePhone(phoneError));
document.getElementById("pwd").addEventListener("blur",()=> validatePassword(pwdError));
...
submitBtn.addEventListener('click' ,(e)=>{
    ...
    if (!validateName(nameError)) isValid = false;
    if (!validateEmail(emailError)) isValid = false;
    if (!validatePhone(phoneError)) isValid = false;
    if (!validatePassword(pwdError)) isValid = false;
...
function validatePassword(pwdError){
